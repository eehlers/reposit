...
#include <rpxl/functions/functioncount.hpp>
...
XLL_DEC long *ohTrigger(
    ...
    try {
        functionCall = boost::shared_ptr<reposit::FunctionCall>
            (new reposit::FunctionCall("ohTrigger"));
        ...
        returnValue = iterators[reposit::FunctionCall::instance().addressString()]++;
        return &returnValue;
...
XLL_DEC OPER *ohPack(OPER *xInputRange) {
    ...
    try {
        functionCall = boost::shared_ptr<reposit::FunctionCall>
            (new reposit::FunctionCall("ohPack"));
...
XLL_DEC char *ohRetrieveErrorImpl(XLOPER *xRange) {
    try {
        std::string returnValue =
            reposit::RepositoryXL::instance().retrieveError(xRange);
